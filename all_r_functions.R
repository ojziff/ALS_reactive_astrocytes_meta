...
# DESeq2 Functions ------------------
curated_profiles <- 
  function(gprofiles = IRevents_gprofiles_curated, colours = 3, cols =  c("firebrick2", "dodgerblue2", "forestgreen")){
...
volcano_plot_deseq.pvalue <-  
  function(data = mn_d25.res, labels_list = volcano.labels){
    labels_plot <- data %>% filter(gene_name %in% labels_list, pvalue < 0.05)
