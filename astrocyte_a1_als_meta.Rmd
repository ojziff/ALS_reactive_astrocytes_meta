...
# git_commit("astrocyte comparison") # commit with comment
# pr_pull()
```
...
a1_datasets = DESeq.analysis(metadata = a1_datasets.metadata, design = ~ cellline + group, contrast = "group_a1_vs_a0", species = "human", transcript.level = FALSE) # cellline contains dataset & replicate
