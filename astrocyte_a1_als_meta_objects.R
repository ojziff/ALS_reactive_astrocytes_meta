...
# IRFinder ----------------------------------------------------------------
ir.als_datasets = IRFinder.analysis(metadata = als_datasets.metadata, sample.names = "sample", variable.name = "group", ctrl = "ctrl", mut = "als", batch = "dataset", file.var = "irfinder", ge.res = als_datasets$res, irfinder.dir = "/camp/home/ziffo/home/projects/astrocyte-a1-als-meta/splicing/irfinder")
ir.a1_datasets = IRFinder.analysis(metadata = a1_datasets.metadata, sample.names = "sample", variable.name = "group", ctrl = "a0", mut = "a1", batch = "dataset", file.var = "irfinder", ge.res = a1_datasets$res, irfinder.dir = "/camp/home/ziffo/home/projects/astrocyte-a1-als-meta/splicing/irfinder")
ir.mouse_als_datasets = IRFinder.analysis(metadata = mouse_als_datasets.metadata, sample.names = "sample", variable.name = "condition", ctrl = "ctrl", mut = "als", batch = "dataset", file.var = "irfinder", ge.res = mouse_als_datasets$res, animal = "mouse", irfinder.dir = "/camp/home/ziffo/home/projects/astrocyte-a1-als-meta/splicing/irfinder")
ir.guttenplan.A1 = IRFinder.analysis(metadata = guttenplan.A1.metadata, sample.names = "sample", variable.name = "group", ctrl = "A0", mut = "A1", batch = "NA", file.var = "irfinder", ge.res = guttenplan.A1$res, animal = "mouse", irfinder.dir = "/camp/home/ziffo/home/projects/astrocyte-a1-als-meta/splicing/irfinder")
